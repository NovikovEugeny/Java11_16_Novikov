...
public final class ErrorMessage {
    ...
    //sign up
    public final static String INVALID_NAME_MESSAGE = "*At least 2 letters(first capital)";

    public final static String INVALID_MOBILE_MESSAGE = "*correct form: +375xxxxxxxxx";

    public final static String INVALID_PASSWORD_MESSAGE =
            "*At least 8 char.(one letter in each register and one digit)";

    public final static String INVALID_CONFIRM_MESSAGE = "passwords must be equals";
    ...
    //add new drug
    public final static String INVALID_DRUG_NAME_MESSAGE = "*At least 3 letters(first capital)";

    public final static String INVALID_DRUG_AMOUNT_MESSAGE = "*correct form: 20 pills";

    public final static String INVALID_ACTIVE_SUBSTANCES_MESSAGE =
            "*correct form: substance - xx mg/g/ml..., ...";

    public final static String INVALID_COUNTRY_MESSAGE = "*At least 3 letters(first capital)";
