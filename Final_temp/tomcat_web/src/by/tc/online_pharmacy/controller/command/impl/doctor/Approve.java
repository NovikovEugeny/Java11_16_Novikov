...
/**
 * Class describes the object-command, the execution of which opens the recipe
 * on the client's request and extends this recipe validity for 6 months.
 */

public class Approve implements Command {

    private static final Logger logger = LogManager.getLogger(Approve.class.getName());
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            doctorService.approve(description);
