...
/**
 * Class describes the object-command, which displays all messages
 * (message that a good was sent and message about the consideration
 * results of the recipe extension request).
 */
public class ShowMessages implements Command {
    ...
    /**
     * If the command is successful, forwarding to the client home page
