...
public final class TableColumnName {
    ...
    public final static String DRUG_ID = "drug_id";
    public final static String DRUG_NAME = "drug_name";
    public final static String PHARM_GROUP = "pharm_group";
    ...
    public final static String CLIENT_MOBILE = "client_mobile";
